...
| §5.2 | Repository onboarding (provision-new and adopt-existing) | modules/onboarding/flow.md |
| §5.3 | Scaffolding / sync | modules/scaffolding/sync.md |
| §5.4 | Diagnosis (doctor) | modules/fleet/diagnosis.md |
| §5.5 | File drift detection (automated, propose-only) | modules/drift/file-drift.md |
| §5.6 | Settings drift detection (automated, report-only) | modules/drift/settings-drift.md |
| §5.7 | Settings reconciliation (operator-gated apply) | modules/reconcile/flow.md |
| §5.8 | Authorization gate (reused by §5.7 and any settings mutation) | modules/reconcile/consent.md |
| §5.9 | Library versioning & release | modules/versioning/release.md |
| §5.10 | Bootstrap / self-reference resolution | modules/onboarding/bootstrap.md |
| §5.11 | Local fleet scan | modules/fleet/scan.md |
| §5.12 | Version upgrade / downgrade (re-pin) | modules/versioning/repin.md |
| §5.13 | Offboarding (leave Aviato) | modules/offboarding/flow.md |
| §5.14 | Security scanning (baseline) | modules/security/scanning.md |
| §6 | The Consumer Contract | core/consumer-contract.md |
| §6.1 | Declaration file | core/consumer-contract.md |
| §6.2 | Managed-marker format (normative) | core/consumer-contract.md |
| §6.3 | Non-annotatable & operator-owned files (seed-once) | core/consumer-contract.md |
| §6.4 | Consent record (normative) | core/consumer-contract.md |
| §6.5 | Profile name stability | core/consumer-contract.md |
| §6.6 | Variable schema | core/consumer-contract.md |
...
| §11.3 | Privileges are declared and granted (read and deploy alike) | modules/security/supply-chain.md |
| §11.4 | Stored-secret confinement (App Store Connect) | modules/deployment/apple/requirements.md |
...
| §12.1 | Python | modules/languages/python/requirements.md |
| §12.2 | Node (TypeScript + JavaScript) | modules/languages/node/requirements.md |
| §12.3 | Swift | modules/languages/swift/requirements.md |
...
| §13.3 | Documentation site (Zensical → docs branch, multi-version) | modules/deployment/docs-site/requirements.md |
